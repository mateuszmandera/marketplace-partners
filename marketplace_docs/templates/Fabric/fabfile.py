...
def clean_up():
    ...
    run("unset HISTFILE")
    run("apt-get -o DPkg::Lock::Timeout=120 -qqy autoremove")
    run("apt-get -o DPkg::Lock::Timeout=120 -qqy autoclean")
...
def install_pkgs():
    ...
    run("DEBIAN_FRONTEND=noninteractive apt-get -o DPkg::Lock::Timeout=120 -qqy install git gettext")
